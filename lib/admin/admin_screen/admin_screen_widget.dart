...
export 'admin_screen_model.dart';
...
class _AdminScreenWidgetState extends State<AdminScreenWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminScreenModel());
                      ...
                      children: [
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed('account_screen_admin');
                            },
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                    ...
                                    return Column(
                                      ...
                                      children: List.generate(
                                        ...
                                        return Align(
                                          ...
                                          child:
                                              DestinationCompilationAdminWidget(
                                            key: Key(
                                                'Key7bn_${columnIndex}_of_${columnCompilationsRecordList.length}'),
                                            compilation:
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            return InkWell(
                                              ...
                                              child: PackageCardWidget(
                                                key: Key(
                                                    'Keyhlc_${wrapIndex}_of_${wrapPackagesRecordList.length}'),
