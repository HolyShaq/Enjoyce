...
import 'edit_dest_model.dart';
export 'edit_dest_model.dart';

class EditDestWidget extends StatefulWidget {
  const EditDestWidget({
    super.key,
  ...
  @override
  State<EditDestWidget> createState() => _EditDestWidgetState();
}

class _EditDestWidgetState extends State<EditDestWidget> {
  late EditDestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditDestModel());
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: FutureBuilder<DestinationsRecord>(
        future: DestinationsRecord.getDocumentOnce(widget.destination!),
                      ...
                      children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: TextFormField(
                                  controller:
                                      _model.nameDestinationTextController ??=
                                          TextEditingController(
                                    text: containerDestinationsRecord.name,
                                  ),
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.descriptionTextController ??=
                                          TextEditingController(
                                    text:
                                        containerDestinationsRecord.description,
                                  ),
                              ...
                              if (_model.uploadedFileUrls.length >= 1)
                                Expanded(
                                  child: Builder(
                                    builder: (context) {
                                      final listPhotos =
                                          containerDestinationsRecord.images
                                              .toList();
                              ...
                              Expanded(
                                child: TextFormField(
                                  controller: _model.countryTextController ??=
                                      TextEditingController(
                                    text: containerDestinationsRecord.country,
                                  ),
                            ...
                            multiSelectController:
                                _model.categoriesValueController ??=
                                    FormFieldController<List<String>>(_model
                                        .categoriesValue ??= List<String>.from(
                              containerDestinationsRecord.categories ?? [],
                            )),
                            options: [
                              'Beaches',
                              'Forests',
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await containerDestinationsRecord.reference
                                  .update({
