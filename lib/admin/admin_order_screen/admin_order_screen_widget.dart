...
import 'admin_order_screen_model.dart';
export 'admin_order_screen_model.dart';

class AdminOrderScreenWidget extends StatefulWidget {
  const AdminOrderScreenWidget({super.key});

  @override
  State<AdminOrderScreenWidget> createState() => _AdminOrderScreenWidgetState();
}

class _AdminOrderScreenWidgetState extends State<AdminOrderScreenWidget> {
  late AdminOrderScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminOrderScreenModel());
  }
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 5.0, 0.0, 0.0),
                                                  child: Text(
                                                    'The destinations / packages your customers avail for will appear here  :)',
