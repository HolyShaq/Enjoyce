...
abstract class FlutterFlowTheme {
  ...
  late Color firstBrandColor;
  late Color secondBrandColor;
  late Color thirdBrandColor;
  late Color fourthBrandColor;
  late Color fifthBrandColor;
  late Color sixthColor;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryText = const Color(0xFF1D1B1E);
  ...
  late Color firstBrandColor = Color(0xFF4E8BC4);
  late Color secondBrandColor = Color(0xFF96CBFC);
  late Color thirdBrandColor = Color(0xFFC2E1FC);
  late Color fourthBrandColor = Color(0xFFFFC2D9);
  late Color fifthBrandColor = Color(0xFFFF99BE);
  late Color sixthColor = Color(0xFFFE99BD);
  late Color placeholderText = Color(0xFF808080);
  late Color customColor1 = Color(0xFFFBEEE8);
}
