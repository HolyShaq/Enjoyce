...
import 'packagecontext_model.dart';
export 'packagecontext_model.dart';

class PackagecontextWidget extends StatefulWidget {
  const PackagecontextWidget({
    super.key,
  ...
  @override
  State<PackagecontextWidget> createState() => _PackagecontextWidgetState();
}

class _PackagecontextWidgetState extends State<PackagecontextWidget>
    with TickerProviderStateMixin {
  late PackagecontextModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PackagecontextModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<PackagesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final packagecontextPackagesRecord = snapshot.data!;
                              ...
                              children: [
                                ...
                                ToggleIcon(
                                  ...
                                  value: FFAppState().favePackages.contains(
                                      packagecontextPackagesRecord.reference),
                                  onIcon: Icon(
                                    Icons.favorite,
                                    color:
