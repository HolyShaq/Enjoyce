...
import 'adcontext_model.dart';
export 'adcontext_model.dart';

class AdcontextWidget extends StatefulWidget {
  const AdcontextWidget({
    super.key,
  ...
  @override
  State<AdcontextWidget> createState() => _AdcontextWidgetState();
}

class _AdcontextWidgetState extends State<AdcontextWidget>
    with TickerProviderStateMixin {
  late AdcontextModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdcontextModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<DestinationsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final adcontextDestinationsRecord = snapshot.data!;
                              ...
                              children: [
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      2.0, 5.0, 0.0, 0.0),
                                  child: Text(
                                    '${adcontextDestinationsRecord.name}, ${adcontextDestinationsRecord.country}',
                                ...
                                Container(
                                  ...
                                  child: ToggleIcon(
                                    ...
                                    value: FFAppState()
                                        .favoriteDestination
                                        .contains(adcontextDestinationsRecord
                                            .reference),
                                    onIcon: Icon(
                                      Icons.favorite,
                                      color: FlutterFlowTheme.of(context)
                        ...
                        child: Container(
                          ...
                          child: Align(
                            ...
                            child: Padding(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final images = adcontextDestinationsRecord
                                      .images
                                      .toList();
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          _model.showAvail = !_model.showAvail;
                                          setState(() {});
                                        },
