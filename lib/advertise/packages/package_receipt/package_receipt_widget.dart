...
import 'package_receipt_model.dart';
export 'package_receipt_model.dart';

class PackageReceiptWidget extends StatefulWidget {
  const PackageReceiptWidget({
    super.key,
  ...
  @override
  State<PackageReceiptWidget> createState() => _PackageReceiptWidgetState();
}

class _PackageReceiptWidgetState extends State<PackageReceiptWidget> {
  late PackageReceiptModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PackageReceiptModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PackagesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final packageReceiptPackagesRecord = snapshot.data!;
          ...
          child: Scaffold(
            ...
            body: StreamBuilder<DestinationsRecord>(
              stream: DestinationsRecord.getDocument(
                  packageReceiptPackagesRecord.destination!),
              builder: (context, snapshot) {
                // Customize what your widget looks like when it's loading.
                if (!snapshot.hasData) {
                  return Center(
                                      ...
                                      FFButtonWidget(
                                        onPressed: () async {
                                          await OrdersRecord.createDoc(
                                            ...
                                            country: widget.country,
                                            destination: stackDestinationsRecord
                                                .reference,
                                            ...
                                            packageDeal:
                                                packageReceiptPackagesRecord
                                                    .name,
                                            referenceID:
                                                'PCKG${dateTimeFormat('yyyyMMdd', widget.startDate)}',
                                            status: false,
                                          ));
