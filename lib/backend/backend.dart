...
import 'schema/compilations_record.dart';
...
export 'schema/compilations_record.dart';
...
/// Functions to query CompilationsRecords (as a Stream and as a Future).
Future<int> queryCompilationsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CompilationsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CompilationsRecord>> queryCompilationsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CompilationsRecord.collection,
      CompilationsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CompilationsRecord>> queryCompilationsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
